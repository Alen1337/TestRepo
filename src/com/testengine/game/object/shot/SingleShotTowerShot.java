...
public class SingleShotTowerShot extends Shot {
    ...
    public SingleShotTowerShot(Tower towerFrom, Unit target, Damage damage) {
        super(SingleShotTowerShot.WIDTH, SingleShotTowerShot.HEIGHT, towerFrom, target, damage, DamageType.SINGLE_TARGET);
        Debug.Log("["+ this.towerFrom.getTowerType() + Debug.SUCCESS_GAMEOBJECT_SHOT_CREATION);
    }
}
